                ...
                <div class="main-panel" style="padding-top:0px;">
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title"> Reservation Form  </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Reservation Informations</h4>
                                        ...
                                        <form class="forms-sample" action="home.jsp">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Pet Name</label>
                                                <select class="form-control" name="choosepetname" id="exampleSelectGender">
                                                    <%! int i;
                              int dataSize; %>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <select class="form-control" name="chooseroomtype" id="exampleSelectGender">
                                                    <%! int i3;
                              int dataSize3; %>

                                                    <%
                                                        String Arr3[] = KullaniciBilgileri.queryOlustur(2, "select * from pettype pt inner join pet p on p.pettype=pt.pettype and p.owner='"+username+"'").split(",");
                                                        dataSize3 = Arr.length;
                                                        for (int i3 = 0; i3 < 1; i3++) {

                                                    %>
                                                    <option ><%= Arr3[i3]%></option>
                                                    <% } %>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Date</label>
                                                <select class="form-control" name="choosedate" id="exampleSelectGender">
                                                    <%! int n;
                              int dataSize2;
                               %>

                                                    <%
                                                        String ResDate[] = KullaniciBilgileri.rezervasyonListesi().split(",");
                                                        dataSize2 = ResDate.length;
                                                        for (int n = 0; n < dataSize2; n++) {

                                                    %>
                                                    <option><%= ResDate[n]%></option>
                                                    <% }%>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleTextarea1">Reservation Detail (Optional)</label>
                                                <textarea class="form-control" name="resdetail" id="exampleTextarea1" rows="4"></textarea>
                                            </div>
