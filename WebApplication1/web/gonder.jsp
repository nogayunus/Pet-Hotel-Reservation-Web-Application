...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            if (request.getParameter("kullaniciadi").equals(null)) {
                kullaniciAdi = (String) oturum.getAttribute("KullaniciAdi");
            } else {
                kullaniciAdi = (String) request.getParameter("kullaniciadi");
                sifre = (String) request.getParameter("sifre");
            }

            if (KullaniciBilgileri.kullaniciAdiKontrol(kullaniciAdi) == true) {
                oturum.setAttribute("KullaniciAdi", kullaniciAdi);
                if (KullaniciBilgileri.sifreKontrol(kullaniciAdi, sifre)) {

                } else {

                    String redirectURL = "http://localhost:8080/WebApplication1/";
                ...
                isimsoyisim = (String) request.getParameter("isimsoyisim");
                String telefonnumarasi = (String) request.getParameter("telefonnumarasi");
                String adres = (String) request.getParameter("adres");
                String email = (String) request.getParameter("email");

                oturum.setAttribute("KullaniciAdi", kullaniciAdi);
                oturum.setAttribute("Sifre", sifre);
                String isim = (String) oturum.getAttribute("KullaniciAdi");
                if (isimsoyisim != (null)) {
                    if (KullaniciBilgileri.kullaniciAdiKontrol(kullaniciAdi)) {
                        String redirectURL = "http://localhost:8080/WebApplication1/giris.html";
                        response.sendRedirect(redirectURL);
                    }
                    KullaniciBilgileri.musteriEkle(kullaniciAdi, isimsoyisim, sifre, telefonnumarasi, adres, email);
                } else {
                    String redirectURL = "http://localhost:8080/WebApplication1/giris.html";
                    response.sendRedirect(redirectURL);
                }
